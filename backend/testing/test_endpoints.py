...
def test_read_category(client, user_token):
    """
    Test case to verify the read_category endpoint.
...
def test_read_category_by_id(client, user_token):
    """
    Test case to verify the read_category_by_id endpoint.
...
def test_create_category(params, client, user_token):
    """
    Test case to verify the create_category endpoint.
...
def test_update_category(client, user_token):
    """
    Test case to verify the update_category endpoint.
...
def test_delete_category(client, user_token):
    """
    Test case to verify the delete_category endpoint.
...
def test_read_product(client, user_token):
    """
    Test case to verify the read_product endpoint.
...
def test_read_product_by_id(client, user_token):
    """
    Test case to verify the read_product_by_id endpoint.
...
def test_create_product(params, client, user_token):
    """
    Test case to verify the create_product endpoint.
...
def test_read_amount(client, user_token):
    """
    Test case to verify the read_amount endpoint.
...
def test_delete_product(client, user_token):
    """
    Test case to verify the delete_product endpoint.
...
def test_read_employee(client, user_token):
    """
    Test case to verify the read_person endpoint.
...
def test_read_employee_by_id(client, user_token):
    """
    Test case to verify the read_person_by_id endpoint.
...
def test_create_employee(client, user_token):
    """
    Test case to verify the create_person endpoint.
...
def test_update_employee(client, user_token):
    """
    Test case to verify the delete_person endpoint.
...
def test_read_role(client, user_token):
    """
        Test case to verify the read_role endpoint.
...
def test_read_role_by_id(client, user_token):
    """
        Test case to verify the read_role_by_id endpoint.
...
def test_create_role(client, user_token):
    """
        Test case to verify the create_role endpoint.
...
def test_update_role(client, user_token):
    """
        Test case to verify the update_role endpoint.
...
def test_delete_role(client, user_token):
    """
        Test case to verify the delete_role endpoint.
...
def test_read_user(client, user_token):
    """
    Test case to verify the read_user endpoint.
...
def test_create_user(client):
    """
    Test case to verify the create_user endpoint.
...
def test_generate_otp_code(client):
    """
    Test case to verify the generate_otp_code endpoint.
